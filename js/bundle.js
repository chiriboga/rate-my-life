...
(function e(t, n, r) {
    function s(o, u) {
        ...
        var RatingCalculator = function () {
            function RatingCalculator(quiz) {
                _classCallCheck(this, RatingCalculator);

                this.quiz = quiz;
            }

            _createClass(RatingCalculator, [{
                key: "getCategories",
        ...
        var CategoryRating = function () {
            function CategoryRating(vals) {
                _classCallCheck(this, CategoryRating);
            ...
            _createClass(CategoryRating, [{
                ...
                key: "template",
                value: function template(category) {
                ...
                value: function methods() {
                    return {
                        getColorClass: function getColorClass(val) {
        ...
        var Quiz = function () {
            ...
            _createClass(Quiz, [{
                ...
                key: "template",
                value: function template(id, title) {
                ...
                value: function events() {
                    var quiz = this;
                    $(this.app).on('click', '.circle', function () {
                        quiz._methods.selectAnswer(this);
                    });
                ...
                value: function methods() {
                    return {
                        selectAnswer: function selectAnswer(self) {
